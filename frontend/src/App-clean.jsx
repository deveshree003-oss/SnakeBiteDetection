              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    transition: 'all 0.3s',
                    hover: { backgroundColor: activeTab === tab.id ? '#65a30d' : 'rgba(255,255,255,0.1)' }
                  }}
                >
                  <Icon size={18} />
                  <span>{tab.name}</span>
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '32px 16px' }}>
        ...
        {reportResult && activeTab === 'report' && (
          <div style={{
            ...
            <div>
              <p style={{ fontWeight: '600', marginBottom: '4px', margin: '0 0 4px 0' }}>Report Submitted Successfully!</p>
